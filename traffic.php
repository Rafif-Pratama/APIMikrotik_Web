...
<body id="page-top">
                ...
                <div class="container-fluid">
                   ...
                   <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Traffic Network</h1>
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted">&copy; 2021 by <a href="#">Rafif Pratama</a></span>
      </div>
    </footer>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Rafif 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
